...
import biz.gelicon.core.components.erp.todo.documentreal.DocumentRealChangeStatus;
    ...
    private void autoRecognitionIdValue(Object inputObject) {
        ...
        switch (AuditKind.values()[kind]) {
            ...
            case CALL_FOR_SAVE_UPDATE:
                ...
                break;
            case CALL_FOR_CHANGE_STATUS:
                DocumentRealChangeStatus status = (DocumentRealChangeStatus) inputObject;
                this.idValue = new ArrayList<>(status.getDocumentRealIds());
                break;
