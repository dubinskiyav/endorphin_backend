...
import biz.gelicon.core.response.exceptions.MemoryDatasetProcessException;
            ...
            delta.stream()
                    ...
                    .forEach(dr-> {
                        ...
                        try {
                            ...
                            RuntimeException exPos = new MemoryDatasetProcessException(String.format("Ошибка в позиции №%d:", posNumber) + ex.getMessage(), ex);
