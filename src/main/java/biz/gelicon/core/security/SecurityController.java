...
import biz.gelicon.core.components.core.proguser.PasswordAndKeyDTO;
import biz.gelicon.core.components.core.proguser.PasswordAndUserDTO;
import biz.gelicon.core.components.core.proguser.RecoveryPasswordDTO;
import biz.gelicon.core.components.core.proguser.TokenDTO;
...
public class SecurityController {
    ...
    public TokenResponse getToken(@RestrictStoreToAudit @RequestBody UserCredential credential) {
        ...
        if(!crprovider.checkAuthentication(pu.getProguserId(),credential.getPassword())) {
            bruteForceProtection.onAuthenticationFailure(pu.getProguserName());
            throw new IncorrectUserOrPasswordException();
        }
