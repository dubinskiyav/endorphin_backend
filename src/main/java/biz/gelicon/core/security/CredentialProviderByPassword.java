...
import biz.gelicon.core.components.core.progusercredential.ProguserCredential;
...
public class CredentialProviderByPassword implements CredentialProvider<String> {
    ...
    public boolean updateAuthentication(Integer progUserId, String authData, boolean tempFlag) {
        ...
        ProguserCredential credential = proguserCredentialRepository.findByProguser(progUserId, CapCode.AUTH_BYPASSWORD, tempFlag?1:0);
        if(credential!=null) {
