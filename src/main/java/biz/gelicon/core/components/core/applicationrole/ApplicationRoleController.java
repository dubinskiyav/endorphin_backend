...
import biz.gelicon.core.components.core.application.ApplicationService;
import biz.gelicon.core.service.BaseService;
import biz.gelicon.core.utils.ConstantForControllers;
import biz.gelicon.core.utils.GridDataOption;
import biz.gelicon.core.components.core.application.ApplicationView;
...
public class ApplicationRoleController {
    ...
    public DataResponse<ApplicationRoleView> getlist(@RequestBody GridDataOptionApplication gridDataOption) {
        ...
        final char kavichka = (char) 34;
        if(!accessroleFound)
            throw new RuntimeException("Требуется именованный фильтр, пример "
                    + kavichka + "filters" + kavichka + ":{"
                    + kavichka + "accessRoleId" + kavichka + ": 3}");
