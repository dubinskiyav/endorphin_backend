...
public class DubTest  {
    ...
    public void DocumentRealTransitTest() {
        logger.info("!!!!!!!!!!!!!!!                   !!!!!!!!!!!!!!!!!!!!!!!");
        DocumentRealTransit dto = new DocumentRealTransit();
        dto.setDocumentrealId(3);
        dto.setDocumenttransitId(3);
        dto.setDocumentRealTransitRemark("Тест");
        dto.setDocumentRealTransitFlag(0);
        dto.setDocumentRealTransitRemark("Отличное примечание");
    }
